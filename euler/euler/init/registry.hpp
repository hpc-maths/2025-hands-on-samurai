...
#define REGISTER_TEST_CASE(name, box_fn, init_fn, bc_fn)                                             \
    namespace                                                                                        \
    {                                                                                                \
        static const test_case::TestCaseRegistrar<config_2d::field_t> __registrar_##name##_instance{ \
            #name,                                                                                   \
            []()                                                                                     \
            {                                                                                        \
                return box_fn<config_2d::field_t::dim>();                                            \
            },                                                                                       \
            [](config_2d::field_t& u, const typename config_2d::field_t::cell_t& cell)               \
            {                                                                                        \
                init_fn(u, cell);                                                                    \
            },                                                                                       \
            [](config_2d::field_t& u, double& t)                                                     \
            {                                                                                        \
                bc_fn(u, t);                                                                         \
            }};                                                                                      \
    }
